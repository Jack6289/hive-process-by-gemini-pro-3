    ...
    <div className="h-full flex flex-col bg-gray-950 border-l border-gray-800 w-[420px] shadow-2xl z-10">
      <div className="p-5 border-b border-gray-800 bg-gray-900/50">
        <h2 className="text-lg font-bold text-cyan-400 flex items-center gap-2 tracking-wide">
           ...
           AI Engine v8.0 <span className="text-[9px] ml-auto text-blue-400 border border-blue-900 bg-blue-950 px-1 rounded shadow-[0_0_5px_rgba(59,130,246,0.5)]">INTELLIGENT MODE</span>
        </h2>
        <p className="text-[10px] text-gray-500 mt-1 font-mono">CONTEXT-AWARE SAFETY ACTIVE</p>
      </div>
             ...
             <div className="max-h-40 overflow-y-auto border border-gray-800 rounded-lg bg-black/20">
                ...
                {scanResults.slice(0, 500).map((finding) => (
                  ...
                  >
                    ...
                    <span className={`opacity-50 ${finding.confidence >= 1.0 ? 'text-red-400 font-bold' : ''}`}>{finding.type.substring(0,4)}</span>
                  </div>
                ))}
